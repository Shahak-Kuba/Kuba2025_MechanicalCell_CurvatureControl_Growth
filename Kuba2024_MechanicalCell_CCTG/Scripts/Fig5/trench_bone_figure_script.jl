...
f2_nonlinear = Kuba2024_MechanicalCell_CCTG.plotResults1D(sol_nonlinear[geo].u, sol_nonlinear[geo].Density, Density_cmap, Density_Range,  L"q \; \text{[1/μm]}", D, kf, m, N, 10)
save("Scripts/Paper_Figures/Fig5_trench_hookean_cell_traj.pdf", f1_hookean)
save("Scripts/Paper_Figures/Fig5_trench_nonlinear_cell_traj.pdf", f2_nonlinear)
