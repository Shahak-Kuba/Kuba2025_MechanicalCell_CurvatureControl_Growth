...
sol_nonlinear = Kuba2024_MechanicalCell_CCTG.GrowthSimulation(N,m,R₀,D,Kₛ,L₀,kf,η,growth_dir,domain_type,Tmax,δt,btypes,"nonlinear",dist_type,
                    prolif, death, embed, α, β, Ot, event_δt, 1, 5);
sol_hookean2  = Kuba2024_MechanicalCell_CCTG.GrowthSimulation(N,m,R₀,D,kₛ,l₀,kf,η,growth_dir,domain_type,Tmax,δt,btypes,"hookean",dist_type,
                    prolif, death, embed, α, β, Ot, event_δt, 1, 31);
sol_nonlinear2  = Kuba2024_MechanicalCell_CCTG.GrowthSimulation(N,m,R₀,D,Kₛ,L₀,kf,η,growth_dir,domain_type,Tmax,δt,btypes,"nonlinear",dist_type,
                    prolif, death, embed, α, β, Ot, event_δt, 1, 31);
...
save("Scripts/Paper_Figures/Fig6_Mid_Hookean_Cell_Length.pdf", f_length_Hookean)
save("Scripts/Paper_Figures/Fig6_Mid_Hookean_Stress.pdf", f2_hookean)
save("Scripts/Paper_Figures/Fig6_Mid_Nonlinear_Cell_Length.pdf", f_length_Nonlinear)
save("Scripts/Paper_Figures/Fig6_Mid_Nonlinear_Stress.pdf", f2_nonlinear)