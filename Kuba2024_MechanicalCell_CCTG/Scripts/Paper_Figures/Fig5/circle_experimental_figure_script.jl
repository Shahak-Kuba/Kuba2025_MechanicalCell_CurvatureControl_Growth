...
f1_nonlinear = Kuba2024_MechanicalCell_CCTG.plotResults2D_Quadrant(sol_nonlinear[geo].u, sol_nonlinear[geo].Density, Density_cmap, Density_Range,  L"\text{Density} \; q \; \text{[1/μm]}", (300,300), N, m, 10)
...
save("Scripts/Paper_Figures/Fig5_circle_nonlinear_cell_traj.pdf", f1_nonlinear)
